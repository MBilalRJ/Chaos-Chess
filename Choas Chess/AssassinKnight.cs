...
public class AssassinKnight : ChessPiece
{
    public override List<Vector2Int> GetAvailableMoves()
    {
        ...
        Vector2Int[] knightMoves = {
            ...
            new Vector2Int(1, 1),   // Move top right
            new Vector2Int(1, -1),  // Move top left
            new Vector2Int(-1, 1),  // Move bottom right
            new Vector2Int(-1, -1), // Move bottom left
        };
